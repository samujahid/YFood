		...
		<div class="span9">
			<div class="restaurant">
				...
				<div class="row-fluid">
					<div class="span12">
						<div class="prelative">
							<div class="food-wallpaper">
								<img src="images/restaurant/banner/banner_2.jpg" alt="" />
							</div>
							<div class="restaurant-logo-banner">
								<img src="images/restaurant/logo/zaffron.jpg" alt="" />
							</div>
						</div>
					</div>
				</div>
				<div class="clearfix">
									...
									<div class="row-fluid">
										<div class="span12">
											<div class="row-fluid">
												...
												<div class="span2">
													<div><span class="i-inr"></span> Item Price</div>
												</div>
												<div class="span2">
					...
					<div class="restaurant-content">
						<div class="restaurant-lists even">
							<div class="row-fluid">
								<div class="span12">
									<div class="restro">
										<div class="row-fluid">
											<div class="span12">
												<div class="row-fluid">
													<div class="span4">
														<div class="restro-item-order">Panner Tikka Masala</div>
													</div>
													<div class="span2">
														<div class="item-price"><span class="i-inr"></span> 200</div>
													</div>
													<div class="span2">
														<div class="ordered-count">200</div>
													</div>
													<div class="span2">
														<div class="rating">* * * * *</div>
													</div>
													<div class="span2">
														<div class="add-to-cart"><a class="btn btn-small btn-warning" href="#">Order Now</a></div>
													</div>
												</div>
											</div>
										</div>
						...
						<div class="restaurant-lists odd">
							<div class="row-fluid">
								<div class="span12">
									<div class="restro">
										<div class="row-fluid">
											<div class="span12">
												<div class="row-fluid">
													<div class="span4">
														<div class="restro-item-order">Chicken Tikka Masala</div>
													</div>
													<div class="span2">
														<div class="item-price"><span class="i-inr"></span> 200</div>
													</div>
									...
									<div class="restro">
										<div class="row-fluid">
											<div class="span12">
												<div class="row-fluid">
													<div class="span4">
														<div class="restro-item-order">Hara Barah Kabab</div>
													</div>
													<div class="span2">
														<div class="item-price"><span class="i-inr"></span> 200</div>
													</div>
									...
									<div class="restro">
										<div class="row-fluid">
											<div class="span12">
												<div class="row-fluid">
													<div class="span4">
														<div class="restro-item-order">Chicken Biryani</div>
													</div>
													<div class="span2">
														<div class="item-price"><span class="i-inr"></span> 200</div>
													</div>
